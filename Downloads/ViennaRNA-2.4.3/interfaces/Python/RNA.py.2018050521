...
class fold_compound(object):
    ...
    def path_findpath_saddle(self, struc1, struc2, max):
        return _RNA.fold_compound_path_findpath_saddle(self, struc1, struc2, max)

    def path_findpath(self, s1, s2, maxkeep):
